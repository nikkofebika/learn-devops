...
func loadPostgresConfig() (string, error) {
	dbUser := getString(os.Getenv("DB_USER"), "root")
	dbPassword := getString(os.Getenv("DB_PASSWORD"), "secret")
	dbHost := getString(os.Getenv("DB_HOST"), "localhost")
	dbPort := getString(os.Getenv("DB_PORT"), "5432")
	dbDatabase := getString(os.Getenv("DB_DATABASE"), "todolist")
